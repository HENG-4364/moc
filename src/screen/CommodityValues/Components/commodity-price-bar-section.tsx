...
import { CommodityPriceBarChart } from "./commodity-price-bar-chart";
import moment from "moment";
import { format } from "date-fns";

export type CommodityPriceBarSectionProps = {
...
export const CommodityPriceBarSection = ({
  productList,
  publicProvinceList,
  setTab,
  tab,
}: CommodityPriceBarSectionProps) => {
